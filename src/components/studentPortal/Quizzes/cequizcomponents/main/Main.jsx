        ...
        <div className="terminal-wrapper fadeIn">
            <div className="terminal-top ">
                ...
                <div className="top-mid delay-1_3 fadeIn">
                    ...
                    <span className="">Civic Education Quiz</span>
                </div>
                <div>
                </div>
            </div>
            <div className="terminal-bot">
                ...
                <p className="terminal-prompt fadeIn delay-3_5"><span className="terminal-green">{d.getHours()}:{minutes} </span> Remember your have 5 minutes to answer the following questions.</p>
